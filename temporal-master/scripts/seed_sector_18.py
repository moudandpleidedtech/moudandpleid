...
SECTOR_18 = [
    # ── L155 — raise explícito ────────────────────────────────────────────────
    {
        ...
        "initial_code": (
            "def dividir(a, b):\n"
            "    pass  # TU CÓDIGO AQUÍ (usá raise ValueError si b == 0)\n"
            "\n"
            "print(dividir(10, 2))\n"
            "\n"
            "try:\n"
    ...
    # ── L156 — Excepción custom ────────────────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "    pass  # TU CÓDIGO AQUÍ (lanzá ErrorDeAcceso si nivel < 5)\n"
            "\n"
            "try:\n"
    ...
    # ── L157 — Encadenamiento de excepciones ──────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "    pass  # TU CÓDIGO AQUÍ (usá raise ... from None)\n"
            "\n"
            "try:\n"
    ...
    # ── L158 — finally garantizado ────────────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "    try:\n"
            "        pass  # TU CÓDIGO AQUÍ (raise ValueError si datos vacíos, sino suma)\n"
            "    except ValueError as e:\n"
            "        print(f'Error: {e}')\n"
            "    finally:\n"
            "        pass  # TU CÓDIGO AQUÍ (siempre cerrar la conexión)\n"
            "\n"
