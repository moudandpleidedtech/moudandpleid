"""
seed_sector_08.py — Sector 08: El Paradigma de Objetos (POO)
=============================================================
...
Uso standalone:
    ...
    python -m scripts.seed_sector_08 --dry-run
"""
        ...
        try:
            if not dry_run:
                await session.execute(
                    delete(Challenge).where(Challenge.sector_id == 8)
                )
            ...
            if not dry_run:
                ...
                print(f"\n  💾  Commit OK — {len(SECTOR_08)} misiones insertadas.")
