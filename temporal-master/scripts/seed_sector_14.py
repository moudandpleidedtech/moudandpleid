...
SECTOR_14 = [
    ...
    # ── L124 — Generador de Contraseña ───────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "    if any(c in '@#$%' for c in pwd):        puntos += 1\n"
    ...
    # ── L125 — Serializar / Deserializar ─────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "    return ';'.join(f'{k}={v}' for k, v in sorted(datos.items()))\n"
            "\n"
    ...
    # ── L127 — Clase con __str__ ──────────────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "\n"
            "    def __str__(self):\n"
            "        return f'[{self.callsign}] Nivel {self.nivel} — {self.xp} XP'\n"
            "\n"
    ...
    # ── L129 — Máximo de Columnas ─────────────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "    return [max(col) for col in zip(*matriz)]\n"
            "\n"
            "matriz = [\n"
            "    [3, 1, 4],\n"
            "    [1, 5, 9],\n"
