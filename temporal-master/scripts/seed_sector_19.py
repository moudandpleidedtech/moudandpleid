...
SECTOR_19 = [
    ...
    # ── L161 — json.dumps / json.loads ────────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "\n"
            "# Paso 1: Convertí datos a JSON string con indent=2 e imprimilo\n"
            "# TU CÓDIGO AQUÍ\n"
            "\n"
            "# Paso 2: Volvé a parsearlo y accedé al campo 'mision'\n"
            "# TU CÓDIGO AQUÍ\n"
        ),
        "expected_output": '{\n  "operador": "NEXO",\n  "nivel": 7,\n  "mision": "ALFA-01"\n}\nALFA-01',
        "test_inputs_json": json.dumps([]),
    ...
    # ── L162 — Argumentos de CLI (simulado) ───────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "params = {}\n"
            "pares = args[1:]\n"
            "# TU CÓDIGO AQUÍ (recorré pares de 2 en 2 y armá el dict)\n"
            "\n"
            "print(params)\n"
            "print(params['--modo'])\n"
        ),
    ...
    # ── L164 — json con archivos ──────────────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "\n"
            "# Paso 1: Guardá datos en '/tmp/config.json' con json.dump\n"
            "# TU CÓDIGO AQUÍ\n"
            "\n"
            "# Paso 2: Leé el archivo con json.load e imprimí el dict y 'max_ops'\n"
            "# TU CÓDIGO AQUÍ\n"
        ),
    ...
    # ── L165 — BOSS: Proyecto Integrador ──────────────────────────────────────
    {
        ...
        "initial_code": (
            ...
            "\n"
            "    def reporte(self):\n"
            "        pass  # TU CÓDIGO AQUÍ (total, xp_total, tipos únicos ordenados)\n"
            "\n"
