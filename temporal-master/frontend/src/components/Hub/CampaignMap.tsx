...
const ZONES: CampaignZone[] = [
  ...
  },
  {
    ...
    title: 'SALES MASTERY',
    subtitle: 'Technical Sales Codex',
    color: '#FFC700',
    icon: '◈',
    status: 'active',
    nodes: [
      {
        id: 'sales_s1',
        title: 'SECTOR I',
        subtitle: 'Tech-to-Biz Bridge',
        level_range: 'L01 – L05',
        is_boss: false,
        required_boss_name: 'The Infinite Looper (Python Core)',
        nav_path: '/codex/sales/sector/1',
      },
      {
        id: 'sales_s2',
        title: 'SECTOR II',
        subtitle: 'Deep Pain Identification',
        level_range: 'L06 – L09',
        is_boss: false,
        required_boss_name: 'Boss del Sector I',
        nav_path: '/codex/sales/sector/2',
      },
      {
        id: 'sales_boss_cto',
        title: '[ BOSS BATTLE ]',
        subtitle: 'Rivera — CTO Escéptico',
        level_range: 'L10',
        is_boss: true,
        required_boss_name: 'Boss del Sector II',
        nav_path: '/codex/sales/boss/cto',
      },
      {
        id: 'sales_s3',
        title: 'SECTOR III',
        subtitle: 'The CTO/CEO Language',
        level_range: 'L11 – L15',
        is_boss: false,
        required_boss_name: 'Rivera — CTO Escéptico',
        nav_path: '/codex/sales/sector/3',
      },
      {
        id: 'sales_s4',
        title: 'SECTOR IV',
        subtitle: 'The Closing Siege',
        level_range: 'L16 – L19',
        is_boss: false,
        required_boss_name: 'Boss del Sector III',
        nav_path: '/codex/sales/sector/4',
      },
      {
        id: 'sales_boss_ceo',
        title: '[ BOSS FINAL ]',
        subtitle: 'Vargas — CEO en Sala de Juntas',
        level_range: 'L20',
        is_boss: true,
        required_boss_name: 'Boss del Sector IV',
        nav_path: '/codex/sales/boss/ceo',
      },
    ],
  },
  {
    ...
    title: 'TPM MASTERY',
    subtitle: 'Project Manager Codex',
    color: '#FF6B35',
    icon: '◎',
    status: 'active',
    nodes: [
      {
        id: 'tpm_d00',
        title: 'DESAFÍO 00',
        subtitle: 'Bautismo de Código',
        level_range: 'L01 – L29',
        is_boss: false,
        required_boss_name: 'The Infinite Looper (Python Core)',
        nav_path: '/codex/tpm/desafio/0',
      },
      {
        id: 'tpm_d00_boss',
        title: '[ SPRINT INFERNAL ]',
        subtitle: 'Andrés — El Cliente Exigente',
        level_range: 'L30',
        is_boss: true,
        required_boss_name: 'Completar Desafío 00',
        nav_path: '/codex/tpm/boss/sprint-infernal',
      },
      {
        id: 'tpm_p1',
        title: 'FASE 1',
        subtitle: 'The Tech Backbone',
        level_range: 'L31 – L59',
        is_boss: false,
        required_boss_name: 'Sprint Infernal (Boss D00)',
        nav_path: '/codex/tpm/fase/1',
      },
      {
        id: 'tpm_p1_boss',
        title: '[ AUDITORÍA DEL CTO ]',
        subtitle: 'Escrutinio Técnico',
        level_range: 'L60',
        is_boss: true,
        required_boss_name: 'Completar Fase 1',
        nav_path: '/codex/tpm/boss/auditoria-cto',
      },
      {
        id: 'tpm_p2',
        title: 'FASE 2',
        subtitle: 'Ejecución Ágil y Crisis',
        level_range: 'L61 – L90',
        is_boss: false,
        required_boss_name: 'Auditoría del CTO',
        nav_path: '/codex/tpm/fase/2',
      },
      {
        id: 'tpm_p3',
        title: 'FASE 3',
        subtitle: 'Comando Supremo',
        level_range: 'L91 – L100+',
        is_boss: false,
        required_boss_name: 'Viernes Negro (Boss F2)',
        nav_path: '/codex/tpm/fase/3',
      },
    ],
  },
  {
